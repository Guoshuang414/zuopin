...
var active = null;
var oldNum = 0;
var aLi = $('#ulBoxLeft').find('li');
qiehuan();
function qiehuan(){
	var arr = ['white','white','white','white','white'];
...
//			'zIndex':$('section').length-i
	...
	aLi.on('click',function(){
		...
		onOff = false;
		$('body').find('section').removeClass('bottom delay180 top show');
		
		$('body').find('section').eq(oldNum).addClass('bottom delay180 show');
		setTimeout(function(){
			$('body').find('section').eq(_this.attr('index')).addClass('top delay180 show');
			onOff = true;
		},500);
		oldNum = $(this).index();
	})	
...
//aLi	.hover(function(){
//	if(!$(this).attr('onoff')){
//		$(this).find('.divHover').css({'left':'-170px'});	
//	}
//	
//},function(){
//	if($(this).attr('onoff')){
//		$(this).find('.divHover').css({'left':'0'});
//	}
//})
$('.divHover').on('mouseover',function(){
	if($(this).parent().attr('onoff')){
...
function anniu(){
	...
	pic1.click(function(){
		oldNum = 1;
		$('#page_1').addClass('bottom delay180 show');
		setTimeout(function(){
			$('#page_2').addClass('top delay180 show');
		},500);
		$('#wrapBox').css({
			'left':'0',
			'transition':'.5s'
